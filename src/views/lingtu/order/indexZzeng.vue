<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="领取时间" prop="purchaseTime">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="卖家姓名" align="center" prop="purchaseId" />
<el-table-column label="卖家手机" align="center" prop="purchaseId" />
...
<el-table-column label="转增数量" align="center" prop="goodsName" />
<el-table-column label="手续费" align="center" prop="goodsName" />
<el-table-column label="领取状态" align="center" prop="goodsName" />

<el-table-column label="领取时间" align="center" prop="purchaseTime" width="150px">
